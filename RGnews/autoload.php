...
spl_autoload_register(function ($nome_arquivo) {
    if (file_exists("Controllers/" . $nome_arquivo . ".php")) {
     ...
     elseif (file_exists("Models/servicos/" . $nome_arquivo . ".php")) {
        require "./Models/servicos/" . $nome_arquivo . ".php";
    }
     elseif (file_exists("Models/entidades/" . $nome_arquivo . ".php")) {
        require "./Models/entidades/" . $nome_arquivo . ".php";
    }
});
?>
