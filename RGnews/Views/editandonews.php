    ...
    <div class="col-md-7 mb-4 ">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="name" value="<?php echo $titulo; ?>"
           required=""
             oninvalid="this.setCustomValidity('Por favor, entre com Titulo da notícia')"
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="12" name="textocompleto" required=""
             oninvalid="this.setCustomValidity('Por favor, entre com sua Notícia')"
            oninput="setCustomValidity('')" > <?php echo $texto_completo; ?></textarea>
        </div>
        
        <div class="form-group">
          <label for="clientMenssagem">Texo Destaque</label>
          <textarea class="form-control" rows="6" name="textodestaque" 
          required=""
             oninvalid="this.setCustomValidity('Por favor, entre com texto destaque')"
            oninput="setCustomValidity('')"> <?php echo $texto_destaque; ?> </textarea>
        </div>
